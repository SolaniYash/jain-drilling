<!--readme for ragistretion file this file name is registeretion.php-->
<!-- <?php
...
<body>
    ...
    <div class="container text-center text-dark">
        <form method="post">
            ...
            <div class="my-4">
            <input type="submit" class="btn btn-outline-dark" value="Register" name="s1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" class="btn btn-outline-secondary">
            </div>
        </form>
    </div>
</body>
