    ...
    <div class="container my-3">
        <div class="row mb-2">
            ...
            <div class="col-md-6 accordion">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0 text-center">Total No. Of Brochures:-</h3>
                        <div class="text-center display-1">
                            <?php
        ...
        <div class="row mb-2">
            <div class="col-md-6 accordion">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0 text-center">Total No. Of Contect Details</h3>
                        <div class="text-center display-1">
                            <?php
                            $sql = "select * from contect-detail";
                            // $results = mysqli_query($conn, $sql);
            ...
            <div class="col-md-6 accordion">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0 text-center">Total No. Of Complete Details :-</h3>
                        <div class="text-center display-1">
                        <?php
                            $sql = "select * from complete-detail";
                            // $results = mysqli_query($conn, $sql);
