...
<body>
      ...
      <div class="col-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="products.php?id=1" class="btn btn-dark col-12">Explore Now</a>
          </div>
        </div>
      </div>
      <div class="col-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="products.php?id=2" class="btn btn-dark col-12">Explore Now</a>
          </div>
        </div>
      </div>
      <div class="col-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="products.php?id=3" class="btn btn-dark col-12">Explore Now</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row bg-dark text-light">
    ...
    <div class="col-6 my-5">
      ...
      <a href="product-details.php?id=5" class="btn btn-outline-light">Shop Now</a>
    </div>
  </div>
  <div class="row">
    <div class="col-6 text-dark my-5">
      ...
      <a href="" class="btn btn-outline-dark mx-3">Shop Now</a>
    </div>
    <div class="col-6">
